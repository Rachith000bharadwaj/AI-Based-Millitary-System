...
LOCAL_INTELLIGENCE_TEMPLATE = (
    "### 🛡️ AegisAI Tactical Intelligence Assessment\n\n"
    "**Retrieved Sensor Telemetry & Database Analysis**:\n{context}\n\n"
    "**Operational Assessment**: Threat scoring telemetry has been evaluated across active border sectors. "
    "All sensor feeds remain under automated surveillance monitoring with decision-support protocols active."
)
...
def query_intelligence_assistant(question: str, context: str = "") -> dict:
    ...
    if client is None:
        return {
            "answer": LOCAL_INTELLIGENCE_TEMPLATE.format(context=context),
            "online": True,
            "model": "AegisAI Decision Engine",
        }
